def estimator(data):
    ...
    currentlyInfectedImpact = Covid19Cases.currentlyInfectedImpact(
        data['reportedCases'])

    # Worst case

    currentlyInfectedSevere = Covid19Cases.currentlyInfectedSevere(
        data['reportedCases'])

    # Estimated best case after a specified time

    infectionsByTimeImpact = Covid19Cases.infectionsByTime(
        data["periodType"], data['timeToElapse'], currentlyInfectedImpact)

    # Estimated worst case after a specified time

    infectionsByTimeSevere = Covid19Cases.infectionsByTime(
        data["periodType"], data['timeToElapse'], currentlyInfectedSevere)

    # Estimated best case for severe cases after a period of time

    casesByRequestedTimeImpact = Covid19Cases.estimatesevereCasesByRequestedTime(
        infectionsByTimeImpact)

    # Estimated worst case for severe cases after a period of time

    casesByRequestedTimeSevere = Covid19Cases.estimatesevereCasesByRequestedTime(
        infectionsByTimeSevere)
    ...
    bestCase_avalilableBeds = Covid19Cases.estimateAvailableHospitalBeds(
        data["totalHospitalBeds"], casesByRequestedTimeImpact)
    ...
    worstCase_avalilableBeds = Covid19Cases.estimateAvailableHospitalBeds(
        data["totalHospitalBeds"], casesByRequestedTimeSevere)
    ...
    bestCase_loss = Covid19Cases.estimateEconomicLoss(
        ...
        data["region"]["avgDailyIncomeInUSD"], infectionsByTimeImpact)
    ...
    worstCase_loss = Covid19Cases.estimateEconomicLoss(
        data["periodType"], data['timeToElapse'],
        data["region"]["avgDailyIncomePopulation"],
        data["region"]["avgDailyIncomeInUSD"], infectionsByTimeSevere)
    ...
    output_data = {
        ...
        "severeImpact": {
            ...
            "infectionsByRequestedTime": infectionsByTimeSevere,
            "severeCasesByRequestedTime": casesByRequestedTimeSevere,
...
class Covid19Cases():
    ...
    @staticmethod
    def currentlyInfectedImpact(reported_cases):
    ...
    @staticmethod
    def currentlyInfectedSevere(reported_cases):
